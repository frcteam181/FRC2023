...
public class Spool extends SubsystemBase {
    ...
    public Spool(boolean isTuning) {
        ...
        //m_spoolEncoder = m_spool.getAlternateEncoder(SparkMaxAlternateEncoder.Type.kQuadrature, k_throughBoreEncoderCPR);
        ...
        //m_spoolPID.setFeedbackDevice(m_spoolEncoder);
    ...
    public void moveToTuning() {
        var spoolTuningSetpoint = m_spoolTuningSetpoint;
        moveTo(Units.inchesToMeters(spoolTuningSetpoint));
    }
