...
public class freeMovePivot extends CommandBase {
    ...
    public void initialize() {
        System.out.println("Free Move Command Initialized");
        m_minPivotAngle = Units.radiansToDegrees(k_pivotHomeRad);
    ...
    public void end(boolean interrupted) {
        m_arm.enable();
        System.out.println("Free Move Command Ended");
    }
