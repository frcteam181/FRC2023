...
public class highScorePreset extends SequentialCommandGroup {

    private Arm m_arm;
    private Spool m_spool;

    public highScorePreset(Arm arm, Spool spool) {
        ...
        addCommands(
            ...
            m_arm.setPivotGoal(k_pivotHighScoreRad),
            new WaitCommand(2),
            m_spool.moveToCommand(k_spoolHighScoreMeter)
        );
